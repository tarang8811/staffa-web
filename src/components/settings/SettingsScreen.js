...
class SettingsScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      location: !!props.profile.latitude && props.profile.longitude 
  ...
  componentWillReceiveProps(nextProps) {
    if(this.props.profile !== nextProps.profile) {
      this.setState({
        ...
        location: !!nextProps.profile.latitude && nextProps.profile.longitude 
    ...
    return (
      <div className="container">
        <form className="white">
          ...
          <div className="input-field">
            <button className="btn" onClick={this.handleSubmit}>Update Settings</button>
            ...
            </button>
            {
              this.props.profile.isAdmin && this.state.fund &&
                <button onClick={this.addFunds} className="btn btn-success" style={{marginLeft: '10px'}}>
                  Add Funds
                </button>
            }
          </div>
